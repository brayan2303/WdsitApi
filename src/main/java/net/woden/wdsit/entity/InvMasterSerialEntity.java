 ...
 * @author b.algecira
 */
public class InvMasterSerialEntity {
    ...
    public String getSpareFound() {
        return spareFound;
    }

    public void setSpareFound(String spareFound) {
        this.spareFound = spareFound;
    }
