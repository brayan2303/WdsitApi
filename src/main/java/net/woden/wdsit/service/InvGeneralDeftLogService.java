...
import net.woden.wdsit.entity.InvGeneralDeftLogEntity;
 ...
 */
@Service
public class InvGeneralDeftLogService {
    ...
    public ResponseModel create(InvGeneralGoodLogEntity i) {
        ...
        try {
            CallableStatement cs = cn.prepareCall("{call sp_InvGeneralDeftLogCreate(?,?,?,?,?)}");
