 ...
 */
@Service
public class InvMasterSerialDashService {
    ...
    public ResponseModel invStatus() {
        ...
        try {
            ...
            CallableStatement cs = cn.prepareCall("{call sp_InvMasterSerialStatus()}");
    ...
    public ResponseModel listStatus() {                                   //listar en pantalla info
        ...
        try {
            ...
            CallableStatement cs = cn.prepareCall("{call sp_InvMasterSerialCountAll()}");
            ResultSet rs = cs.executeQuery();
            while (rs.next()) {
    ...
    public ResponseModel listPerson() {                                   //listar en pantalla info
        ...
        try {
            ...
            CallableStatement cs = cn.prepareCall("{call sp_InvMasterInitPerson()}");
            ResultSet rs = cs.executeQuery();
            while (rs.next()) {
                InvMasterSerialEntity i = new InvMasterSerialEntity();
